...
def preprocess(data_path, drop_columns):
    """
    ...
    if drop_columns is None:
        drop_columns=[11, 12, 13, 14, 15, 16, 17, 18, 19]
...
def classification_reports(model_defs, y_preds, y_true):
    ...
    csv_file_name = 'Ban Xay, Laos Classification Report 2020'
    csv_directory = (r'D:\Work\Code งาน\Lab-docker\RIDA\Results\Classification Report\Predict\26-03-2024')
...
def export_predictions_as_csv(df_rename, y_preds, models_to_load, lat, long, label):
    ...
    csv_file_name = '26-03-2024 Ban Xay, Laos 2020 Burn_Area_Predictions.csv'
    csv_directory = (r'D:\Work\Code งาน\Lab-docker\RIDA\Results\CSV predicted\26-03-2024\[Laos] Ban Xay')
    full_path = os.path.join(csv_directory, csv_file_name)
...
def main():
    ...
    data_path = (r'D:\Work\Code งาน\Lab-docker\RIDA\RIDA_CSV\Predict\26-03-2024\[Laos] Ban Xay\2020\T48QUH_20200312T033531_B12_burn_data.csv')
    drop_columns = None
    df_rename, label, lat, long = preprocess(data_path, drop_columns)
    ...
    model_path = (r'D:\Work\Code งาน\Lab-docker\RIDA\Export Model\26-03-2024')
